...
ActiveRecord::Schema[7.0].define(version: 2020_09_13_222603) do
  ...
  create_table "locations", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    ...
    t.index ["server_id", "name"], name: "index_locations_on_server_id_and_name", unique: true
    t.index ["server_id"], name: "index_locations_on_server_id"
  ...
  add_foreign_key "locations", "servers", on_delete: :cascade
  add_foreign_key "locations", "users", on_delete: :nullify
  add_foreign_key "servers", "users", on_delete: :nullify
